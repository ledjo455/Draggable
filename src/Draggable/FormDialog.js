...
export default function FormDialog({setData, data}) {
 ...
 const addModalData = (passedData) => {
  ...
  const handleSave = () => {
    ...
    addModalData({id: increment, src: "https://w7.pngwing.com/pngs/305/613/png-transparent-airplane-aircraft-icon-orange-airplane-icon-angle-camera-icon-phone-icon.png",
  ...
  return (
    <div>
      ...
      <Dialog className="dialog" open={open} onClose={handleClose}>
        <DialogTitle className="dialog">Add an Event</DialogTitle>
